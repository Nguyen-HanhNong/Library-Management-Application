...
Book::Book(const Book &copyBook): title(copyBook.title), author(copyBook.author), genre(copyBook.genre), subgenre(copyBook.subgenre), publisher(copyBook.publisher), pageCount(copyBook.pageCount), ID(copyBook.ID)
{
}
